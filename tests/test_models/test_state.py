...
class TestState(unittest.TestCase):
    ...
    def test_1_id_unique(self):
        ...
        a = [State().id for i in range(1000)]
    ...
    def test_1_str(self):
        ...
        self.assertEqual(res.group(1), "State")
